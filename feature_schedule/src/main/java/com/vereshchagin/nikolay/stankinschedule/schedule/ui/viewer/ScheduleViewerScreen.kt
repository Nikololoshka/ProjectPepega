...
import com.vereshchagin.nikolay.stankinschedule.schedule.ui.editor.PairEditorActivity
import com.vereshchagin.nikolay.stankinschedule.schedule.ui.viewer.components.PairColors
import com.vereshchagin.nikolay.stankinschedule.schedule.ui.viewer.components.ScheduleDayCard
import com.vereshchagin.nikolay.stankinschedule.schedule.ui.viewer.components.ScheduleViewerToolBar
            ...
            items(scheduleDays, key = { it.day }) { day ->
                if (day != null) {
                    ScheduleDayCard(
                        ...
                        pairColors = colors,
                        onPairClicked = {
                            context.startActivity(Intent(context, PairEditorActivity::class.java))
                        },
