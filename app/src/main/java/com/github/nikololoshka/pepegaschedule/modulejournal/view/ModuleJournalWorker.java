...
import com.github.nikololoshka.pepegaschedule.modulejournal.view.model.Discipline;
import com.github.nikololoshka.pepegaschedule.modulejournal.view.model.MarkType;
                ...
                if (oldMarks != null) {
                    ...
                    if (!changes.isEmpty()) {
                        ...
                        Notification notification = NotificationUtils
                                .createModuleJournalNotification(getApplicationContext())
                                .setContentTitle(getString(R.string.notification_mj))
                                .setContentText("Debug a message")
                                .setWhen(System.currentTimeMillis())
                                .setSmallIcon(R.drawable.ic_nav_module_journal)
                                .build();
