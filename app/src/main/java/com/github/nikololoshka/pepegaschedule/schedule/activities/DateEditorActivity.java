...
public class DateEditorActivity extends AppCompatActivity
    ...
    private GridLayout mSingleDate;
    private GridLayout mRangeDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRangeDate = findViewById(R.id.range_date);
        ...
        mSpinnerDate.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0:
                        mSingleDate.setVisibility(View.VISIBLE);
                        mRangeDate.setVisibility(View.GONE);
                        break;
                    case 1:
                        mSingleDate.setVisibility(View.GONE);
                        mRangeDate.setVisibility(View.VISIBLE);
                        break;
                }
            }
