...
import com.vereshchagin.nikolay.stankinschedule.ui.modulejournal.network.response.MarkResponse;
import com.vereshchagin.nikolay.stankinschedule.ui.modulejournal.network.response.SemestersResponse;
import com.vereshchagin.nikolay.stankinschedule.ui.modulejournal.view.model.Discipline;
import com.vereshchagin.nikolay.stankinschedule.ui.modulejournal.view.model.MarkType;
            ...
            if (response.isSuccessful() && response.body() != null) {
                ...
                if (oldMarks != null) {
                    ...
                    if (!changes.isEmpty()) {
                        ...
                        PendingIntent mjPendingIntent = new NavDeepLinkBuilder(context)
