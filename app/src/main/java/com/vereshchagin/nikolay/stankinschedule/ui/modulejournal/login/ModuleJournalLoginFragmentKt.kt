 ...
 */
class ModuleJournalLoginFragmentKt : BaseFragment<FragmentModuleJournalLoginBinding>(),
    ...
    private val loadAnimator = ValueAnimator().apply {
        duration = 300
        addUpdateListener(this@ModuleJournalLoginFragmentKt::loadAnimatorUpdate)
    }
    ...
    private fun loadAnimatorUpdate(animator: ValueAnimator) {
        binding.mjLoginLoading.layoutParams.height = animator.animatedValue as Int
        binding.mjLoginLoading.requestLayout()
    }
