package com.vereshchagin.nikolay.stankinschedule.core.data.notification
...
object NotificationUtils {
    ...
    const val MODULE_JOURNAL_IDS: Int = 10_000_000
    const val COMMON_IDS: Int = 20_000_000
     ...
     */
    @JvmStatic
    fun createModuleJournalNotification(
        context: Context,
